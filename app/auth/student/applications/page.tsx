...
export default function ApplicationsPage() {
  ...
  const getStatusColor = (status: string) => {
    switch (status.toLowerCase()) {
      ...
      case "accepted": return "bg-lime-100 text-lime-700 border-lime-200"; // Matching Home lime
  ...
  return (
    <div className="min-h-screen bg-white pb-10 -mx-4 -mt-6">
      ...
      <section className="bg-sky-700 py-16 px-6 text-center text-white mb-10">
        <motion.h1 
        ...
        <p className="mt-4 text-sky-100 max-w-2xl mx-auto font-medium">
          Manage and track the progress of your internship applications in real-time.
        </p>
      </section>
      ...
      <div className="max-w-5xl mx-auto px-6">
        {applications.length === 0 ? (
          ...
          >
            ...
            <p className="text-gray-500 mt-2">Start exploring opportunities and jumpstart your career.</p>
          </motion.div>
        ) : (
